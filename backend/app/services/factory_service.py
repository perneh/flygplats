...
from app.models import Course, GolfClub, Hole, Player, Round, Shot, Tournament


class FactoryService:
    async def clear_all_data(self, session: AsyncSession) -> None:
        """Remove every row from all tables (shots → rounds → tournaments → holes → courses → players → golf_clubs)."""
